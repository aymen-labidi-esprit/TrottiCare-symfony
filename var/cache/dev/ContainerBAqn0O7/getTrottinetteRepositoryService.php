...
{
    /**
     * Gets the private 'App\Repository\TrottinetteRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrottinetteRepository.php';

        return $container->privates['App\\Repository\\TrottinetteRepository'] = new \App\Repository\TrottinetteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
