...
class getUtilisateurRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\UtilisateurRepository'])) {
            return $container->privates['App\\Repository\\UtilisateurRepository'];
        }

        return $container->privates['App\\Repository\\UtilisateurRepository'] = new \App\Repository\UtilisateurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
