...
class getEventRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\EventRepository'])) {
            return $container->privates['App\\Repository\\EventRepository'];
        }

        return $container->privates['App\\Repository\\EventRepository'] = new \App\Repository\EventRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
