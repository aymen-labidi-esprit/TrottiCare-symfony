...
class getMaintenanceControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Service/TwilioNotifierService.php';

        $container->services['App\\Controller\\Admin\\MaintenanceController'] = $instance = new \App\Controller\Admin\MaintenanceController(($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container)), ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), new \App\Service\TwilioNotifierService());
