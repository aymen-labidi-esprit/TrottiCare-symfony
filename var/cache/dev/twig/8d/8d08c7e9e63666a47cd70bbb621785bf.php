...
class __TwigTemplate_cd590abfbf035ba5c8e86fe92da507e8 extends Template
{
        ...
        yield "</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ";
        // line 75
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["maintenance"]) || array_key_exists("maintenance", $context) ? $context["maintenance"] : (function () { throw new RuntimeError('Variable "maintenance" does not exist.', 75, $this->source); })()), "trottinette", [], "any", false, false, false, 75), "etat", [], "any", false, false, false, 75), "value", [], "any", false, false, false, 75) == "DISPONIBLE")) {
            // line 76
            yield "                                                <span class=\"badge bg-success\">Disponible</span>
                                            ";
        } elseif ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,         // line 77
(isset($context["maintenance"]) || array_key_exists("maintenance", $context) ? $context["maintenance"] : (function () { throw new RuntimeError('Variable "maintenance" does not exist.', 77, $this->source); })()), "trottinette", [], "any", false, false, false, 77), "etat", [], "any", false, false, false, 77), "value", [], "any", false, false, false, 77) == "EN_LOCATION")) {
            // line 78
                            ...
                            <table class=\"table\">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>État</th>
                                        <td>
                                            {% if maintenance.trottinette.etat.value == 'DISPONIBLE' %}
                                                <span class=\"badge bg-success\">Disponible</span>
                                            {% elseif maintenance.trottinette.etat.value == 'EN_LOCATION' %}
...
{% endblock %}", "maintenance/show.html.twig", "C:\\Trottinettenada\\templates\\maintenance\\show.html.twig");
    }
}
