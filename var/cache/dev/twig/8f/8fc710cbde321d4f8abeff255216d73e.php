...
class __TwigTemplate_b3af78c8093985b67175d2297330b0d3 extends Template
{
...
";
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        yield "    ";
        // line 192
        yield "    <div class=\"min-h-[calc(100vh-150px)] flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8\"> ";
        // line 193
        yield "    <div class=\"max-w-md w-full space-y-8\">
    ";
        // line 195
        yield "    <div class=\"bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200\">
    ...
    ";
        ...
        yield "    ";
        try {
            $_v0 = $this->loadTemplate("partials/_flash_messages.html.twig", "security/login.html.twig", 202);
        } catch (LoaderError $e) {
    ...
    ";
        // line 205
        yield "    ";
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 205, $this->source); })())) {
            // line 206
            yield "        <div class=\"alert-base alert-danger mb-4\" role=\"alert\">
            <i class=\"bi bi-exclamation-triangle-fill\"></i>
            <span>";
            // line 208
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(CoreExtension::getAttribute($this->env, $this->source, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 208, $this->source); })()), "messageKey", [], "any", false, false, false, 208), CoreExtension::getAttribute($this->env, $this->source, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 208, $this->source); })()), "messageData", [], "any", false, false, false, 208), "security"), "html", null, true);
            yield "</span>
    ...
    ";
        ...
        yield "    ";
        // line 213
        yield "    <div id=\"loginStatus\" class=\"mb-4\"></div>

    ";
        // line 216
        yield "    <div id=\"email-container\" class=\"space-y-4\">
        ...
        <div>
            ...
            <input type=\"email\" id=\"inputEmail\" class=\"form-input\" value=\"";
        // line 220
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["last_username"]) || array_key_exists("last_username", $context) ? $context["last_username"] : (function () { throw new RuntimeError('Variable "last_username" does not exist.', 220, $this->source); })()), "html", null, true);
        yield "\" required autofocus autocomplete=\"email\">
        </div>
        <div>
    ...
    ";
        // line 230
        yield "    <form id=\"password-form\" method=\"post\" action=\"";
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_login_authenticate_password");
        yield "\" class=\"hidden space-y-4 mt-4\">
    ...
    ";
        // line 249
        yield "    <div id=\"face-login-container\" class=\"hidden mt-4 text-center space-y-4\">
        ...
        ";
        // line 256
        yield "        <div id=\"webcam-ui\" class=\"hidden space-y-3\">
            <p class=\"text-center text-sm text-gray-600\">Autorisez la webcam et centrez votre visage.</p>
            <div class=\"relative inline-block mx-auto w-[240px] h-[180px]\"> ";
        // line 259
        yield "                <video id=\"webcamFeedLogin\" width=\"240\" height=\"180\" autoplay muted playsinline class=\"border border-gray-300 rounded-md shadow-sm bg-gray-200 block\"></video>
                <div id=\"videoOverlayLogin\" style=\"display: none;\"> ";
        // line 261
        yield "                    <div class=\"spinner-tw\"><span class=\"sr-only\">Chargement...</span></div>
                </div>
            </div>
    ...
    <div class=\"text-center text-sm text-gray-600 space-y-1\"> ";
        // line 284
        yield "        <p>Pas encore de compte ? <a href=\"";
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_register");
        yield "\" class=\"font-medium text-blue-600 hover:text-blue-500 hover:underline\">Inscrivez-vous</a></p>
        ";
        // line 286
        yield "        <p><a href=\"";
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_forgot_password_request");
        yield "\" class=\"font-medium text-blue-600 hover:text-blue-500 hover:underline\">Mot de passe oublié ?</a></p>
        ";
        // line 288
        yield "    </div>
    ...
    public function block_javascripts(array $context, array $blocks = []): iterable
    {
        ...
        // line 456
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_login_check_email_caps");
        yield "\", {
                            method: 'POST',
                ...
                identifyFaceButton.addEventListener('click', async () => {
                    ...
                    try {
                        ...
                        if (detection) {
                            ...
                            const response = await fetch(\"";
        // line 542
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_login_authenticate_face");
        yield "\", {
                                method: 'POST',
                                headers: {'Content-Type': 'application/x-www-form-urlencoded', 'Accept': 'application/json'},
...
";
    ...
    {
        return array (  736 => 542,  647 => 456,  488 => 299,  486 => 298,  482 => 297,  469 => 296,  458 => 293,  456 => 292,  454 => 291,  450 => 288,  445 => 286,  440 => 284,  416 => 261,  413 => 259,  409 => 256,  401 => 249,  389 => 238,  378 => 230,  366 => 220,  360 => 216,  356 => 213,  354 => 212,  347 => 208,  343 => 206,  340 => 205,  337 => 203,  326 => 202,  318 => 195,  315 => 193,  313 => 192,  311 => 191,  298 => 190,  108 => 9,  106 => 8,  102 => 7,  89 => 6,  66 => 4,  43 => 2,);
    }
...
{% endblock %}", "security/login.html.twig", "/Users/mac/Downloads/my_project_troti-vf/templates/security/login.html.twig");
    }
}
