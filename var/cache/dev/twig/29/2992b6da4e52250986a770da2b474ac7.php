    ...
    <div class=\"row justify-content-center\">
        ...
        yield "</span>
                        ...
                        <li class=\"list-group-item d-flex justify-content-between align-items-center\">
                            ...
                            <span>";
        // line 23
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["reservation"]) || array_key_exists("reservation", $context) ? $context["reservation"] : (function () { throw new RuntimeError('Variable "reservation" does not exist.', 23, $this->source); })()), "dateReservation", [], "any", false, false, false, 23)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, (isset($context["reservation"]) || array_key_exists("reservation", $context) ? $context["reservation"] : (function () { throw new RuntimeError('Variable "reservation" does not exist.', 23, $this->source); })()), "dateReservation", [], "any", false, false, false, 23), "Y-m-d"), "html", null, true)) : (""));
        yield "</span>
                        </li>
                        <li class=\"list-group-item d-flex justify-content-between align-items-center\">
        ...
        // line 35
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["reservation"]) || array_key_exists("reservation", $context) ? $context["reservation"] : (function () { throw new RuntimeError('Variable "reservation" does not exist.', 35, $this->source); })()), "paiement", [], "any", false, false, false, 35), "label", [], "method", false, false, false, 35), "html", null, true);
        yield "</span>
                        </li>
                    </ul>
                </div>
...
";
    ...
    {
        return array (  234 => 90,  221 => 89,  191 => 68,  179 => 58,  170 => 52,  166 => 51,  154 => 42,  144 => 35,  137 => 31,  130 => 27,  123 => 23,  116 => 19,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
            ...
            <div class=\"card shadow-lg border-0 fade-in\">
                ...
                <div class=\"card-body p-4\">
                    <ul class=\"list-group list-group-flush\">
                        ...
                        <li class=\"list-group-item d-flex justify-content-between align-items-center\">
                            <strong>Date de réservation</strong>
                            <span>{{ reservation.dateReservation ? reservation.dateReservation|date('Y-m-d') : '' }}</span>
                        </li>
                        <li class=\"list-group-item d-flex justify-content-between align-items-center\">
                            <strong>Montant</strong>
...
{% endblock %}
", "reservation/show.html.twig", "C:\\Users\\MSI\\Desktop\\takwa\\TrottiCare\\templates\\reservation\\show.html.twig");
    }
}
