...
class Event extends \App\Entity\Event implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'trottinetteMinAutonomie' => [parent::class, 'trottinetteMinAutonomie', null, 16],
        ...
        'trottinetteMinAutonomie' => [parent::class, 'trottinetteMinAutonomie', null, 16],
    ];
