...
class getHomeController2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Public'.\DIRECTORY_SEPARATOR.'HomeController.php';

        $container->services['App\\Controller\\Public\\HomeController'] = $instance = new \App\Controller\Public\HomeController();
