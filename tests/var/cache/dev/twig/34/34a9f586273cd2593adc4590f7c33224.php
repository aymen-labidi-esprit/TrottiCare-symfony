...
class __TwigTemplate_75471f21f84ca27babc1892716107694 extends Template
{
    ...
    <script>
        ...
        html5QrCode.start(
            ...
            qrCodeMessage => {
                fetch(\"";
        // line 14
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("api_client_qr_process");
        yield "\", {
                    method: 'POST',
...
{% block body %}
    ...
    <script>
        ...
        html5QrCode.start(
            ...
            { fps: 10, qrbox: 250 },
            qrCodeMessage => {
                fetch(\"{{ path('api_client_qr_process') }}\", {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
                    body: JSON.stringify({ code: qrCodeMessage })
                })
...
{% endblock %}
", "client/dashboard/qr_scan.html.twig", "C:\\Users\\PC\\Downloads\\inetgration symfony\\my_project_troti-vf\\my_project_troti-vf\\templates\\client\\dashboard\\qr_scan.html.twig");
    }
}
