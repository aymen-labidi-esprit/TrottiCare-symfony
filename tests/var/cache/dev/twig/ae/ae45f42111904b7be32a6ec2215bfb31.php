...
class __TwigTemplate_cf7a00669f8deea87cc545d2d9d0d56b extends Template
{
    ...
    {
        return new Source("{# Expects 'utilisateur' variable #}
<form method=\"post\" action=\"{{ path('admin_utilisateur_delete', {'id': utilisateur.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?');\" style=\"display: inline-block;\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ utilisateur.id) }}\">
    <button class=\"btn btn-danger btn-sm\" title=\"Supprimer\"><i class=\"fas fa-trash\"></i></button>
</form>", "admin/utilisateur/_delete_form.html.twig", "C:\\Users\\PC\\Downloads\\inetgration symfony\\my_project_troti-vf\\my_project_troti-vf\\templates\\admin\\utilisateur\\_delete_form.html.twig");
    }
}
