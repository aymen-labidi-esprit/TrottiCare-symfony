...
class __TwigTemplate_a24a52b0ff346674ca6e3d40eb8b1bf9 extends Template
{
    ...
    ";
        // line 8
        yield Twig\Extension\CoreExtension::include($this->env, $context, "admin/utilisateur/_form.html.twig", ["button_label" => "Mettre à jour"]);
        yield "

    <a href=\"";
        // line 10
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_utilisateur_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 10, $this->source); })()), "id", [], "any", false, false, false, 10)]), "html", null, true);
        yield "\" class=\"btn btn-info mt-3\">Voir</a>
    <a href=\"";
        // line 11
    ...
    {
        return array (  123 => 14,  118 => 11,  114 => 10,  109 => 8,  103 => 6,  90 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    <h1>Modifier Utilisateur #{{ utilisateur.id }}</h1>

    {{ include('admin/utilisateur/_form.html.twig', {'button_label': 'Mettre à jour'}) }}

    <a href=\"{{ path('admin_utilisateur_show', {'id': utilisateur.id}) }}\" class=\"btn btn-info mt-3\">Voir</a>
    <a href=\"{{ path('admin_utilisateur_index') }}\" class=\"btn btn-secondary mt-3\">Retour à la liste</a>

    {# Optional: Place delete form here as well or instead of show page #}
    {# {{ include('admin/utilisateur/_delete_form.html.twig', {'utilisateur': utilisateur}) }} #}
{% endblock %}", "admin/utilisateur/edit.html.twig", "C:\\Users\\PC\\Downloads\\inetgration symfony\\my_project_troti-vf\\my_project_troti-vf\\templates\\admin\\utilisateur\\edit.html.twig");
    }
}
