...
class __TwigTemplate_006f421db1fa61530abe5ab0137905e7 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "admin/trottinette/index.html.twig", 1);
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["trottinette"]) {
            ...
            yield "                                </td>
                                <td>";
            // line 124
            yield ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["trottinette"], "pointRelais", [], "any", false, false, false, 124), "id", [], "any", false, false, false, 124)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["trottinette"], "pointRelais", [], "any", false, false, false, 124), "id", [], "any", false, false, false, 124), "html", null, true)) : ("Non défini"));
            yield "</td>
                                <td>
...
$context["trottinette"], "batterie", [], "any", false, false, false, 140) > 30)) {
            ...
            yield "</td>
                                <td class=\"text-end\">
                                    <div class=\"btn-group\">
                                        <a href=\"";
            // line 155
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_trottinette_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["trottinette"], "id", [], "any", false, false, false, 155)]), "html", null, true);
            yield "\" class=\"btn btn-sm btn-outline-primary\">
                                            <i class=\"fas fa-eye\"></i>
                                        </a>
                                        <a href=\"";
            // line 158
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_trottinette_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["trottinette"], "id", [], "any", false, false, false, 158)]), "html", null, true);
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["trottinette"]) {
            ...
            // line 198
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_trottinette_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["trottinette"], "id", [], "any", false, false, false, 198)]), "html", null, true);
            yield "\">
...
{% block body %}
    <div class=\"container mt-4\">
        ...
        <div class=\"d-flex justify-content-between align-items-center mb-4\">
            <h1 class=\"fw-bold text-primary mb-0\">Liste des Trottinettes</h1>
            <a href=\"{{ path('admin_trottinette_new') }}\" class=\"btn btn-primary\">
                <i class=\"fas fa-plus me-1\"></i> Nouvelle trottinette
            </a>
        </div>
                    ...
                    <table class=\"table table-hover mb-0\" id=\"trottinetteTable\">
                        ...
                        {% for trottinette in trottinettes %}
                            <tr data-status=\"{{ trottinette.etat.value }}\">
                                ...
                                <td>{{ trottinette.pointRelais.id?: 'Non défini' }}</td>
                                <td>
                                ...
                                <td class=\"text-end\">
                                    <div class=\"btn-group\">
                                        <a href=\"{{ path('admin_trottinette_show', {'id': trottinette.id}) }}\" class=\"btn btn-sm btn-outline-primary\">
                                            <i class=\"fas fa-eye\"></i>
                                        </a>
                                        <a href=\"{{ path('admin_trottinette_edit', {'id': trottinette.id}) }}\" class=\"btn btn-sm btn-outline-secondary\">
                                            <i class=\"fas fa-edit\"></i>
                                        </a>
        ...
        <div class=\"modal fade\" id=\"deleteModal{{ trottinette.id }}\" tabindex=\"-1\" aria-labelledby=\"deleteModalLabel{{ trottinette.id }}\" aria-hidden=\"true\">
            <div class=\"modal-dialog modal-dialog-centered\">
                <div class=\"modal-content\">
                    ...
                    <div class=\"modal-footer\">
                        <button type=\"button\" class=\"btn btn-secondary\" data-bs-dismiss=\"modal\">Annuler</button>
                        <form method=\"post\" action=\"{{ path('admin_trottinette_delete', {'id': trottinette.id}) }}\">
...
{% endblock %}", "admin/trottinette/index.html.twig", "C:\\Users\\PC\\Downloads\\inetgration symfony\\my_project_troti-vf\\my_project_troti-vf\\templates\\admin\\trottinette\\index.html.twig");
    }
}
