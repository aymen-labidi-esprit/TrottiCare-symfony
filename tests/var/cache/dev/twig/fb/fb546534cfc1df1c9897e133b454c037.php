...
class __TwigTemplate_e6d8e3c4151eb45da21ea072f7a5a332 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "admin/trottinette/show.html.twig", 1);
...
(isset($context["trottinette"]) || array_key_exists("trottinette", $context) ? $context["trottinette"] : (function () { throw new RuntimeError('Variable "trottinette" does not exist.', 34, $this->source); })()), "etat", [], "any", false, false, false, 34), "value", [], "any", false, false, false, 34) == "EN_MAINTENANCE")) {
        ...
        // line 69
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["trottinette"]) || array_key_exists("trottinette", $context) ? $context["trottinette"] : (function () { throw new RuntimeError('Variable "trottinette" does not exist.', 69, $this->source); })()), "pointRelais", [], "any", false, false, false, 69)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["trottinette"]) || array_key_exists("trottinette", $context) ? $context["trottinette"] : (function () { throw new RuntimeError('Variable "trottinette" does not exist.', 69, $this->source); })()), "pointRelais", [], "any", false, false, false, 69), "html", null, true)) : ("Non défini"));
        yield "
                                    </p>
                                    <p class=\"card-text\">
        ...
        yield "                    </div>
                ...
                <div class=\"card mb-4\">
                    ...
                    <div class=\"card-body\">
                        ";
        // line 142
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["trottinette"]) || array_key_exists("trottinette", $context) ? $context["trottinette"] : (function () { throw new RuntimeError('Variable "trottinette" does not exist.', 142, $this->source); })()), "pointRelais", [], "any", false, false, false, 142)) {
            // line 143
            yield "                            <p class=\"card-text\">
                                <i class=\"fas fa-hashtag me-2 text-primary\"></i>
                                <strong>Nom:</strong> ";
            // line 145
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["trottinette"]) || array_key_exists("trottinette", $context) ? $context["trottinette"] : (function () { throw new RuntimeError('Variable "trottinette" does not exist.', 145, $this->source); })()), "pointRelais", [], "any", false, false, false, 145), "nom", [], "any", false, false, false, 145), "html", null, true);
            yield "
                            </p>
                            <p class=\"card-text\">
                                <i class=\"fas fa-hashtag me-2 text-primary\"></i>
            ...
            // line 149
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["trottinette"]) || array_key_exists("trottinette", $context) ? $context["trottinette"] : (function () { throw new RuntimeError('Variable "trottinette" does not exist.', 149, $this->source); })()), "pointRelais", [], "any", false, false, false, 149), "adresse", [], "any", false, false, false, 149), "html", null, true);
            yield "
                            </p>
                        ";
        } else {
...
{% block body %}
    <div class=\"container mt-4\">
        ...
        <div class=\"row mb-4\">
            ...
            <div class=\"col-auto\">
                <a href=\"{{ path('admin_trottinette_edit', {'id': trottinette.id}) }}\" class=\"btn btn-warning me-2\">
                    <i class=\"fas fa-edit me-2\"></i>Modifier
                </a>
                <a href=\"{{ path('admin_trottinette_index') }}\" class=\"btn btn-secondary\">
                    <i class=\"fas fa-arrow-left me-2\"></i>Retour à la liste
                </a>
            </div>
        </div>
                        ...
                        <div class=\"row g-4\">
                            ...
                            <div class=\"col-md-6\">
                                <div class=\"mb-3\">
                                    ...
                                    <p class=\"card-text mb-2\">
                                        <i class=\"fas fa-store me-2 text-primary\"></i>
                                        <strong>Point Relais:</strong> {{ trottinette.pointRelais ?: 'Non défini' }}
                                    </p>
                                    <p class=\"card-text\">
                                        <i class=\"fas fa-user me-2 text-primary\"></i>
                                        <strong>Utilisateur:</strong> 
            ...
            <div class=\"col-lg-4\">
                ...
                <div class=\"card mb-4\">
                    ...
                    <div class=\"card-body\">
                        {% if trottinette.pointRelais %}
                            <p class=\"card-text\">
                                <i class=\"fas fa-hashtag me-2 text-primary\"></i>
                                <strong>Nom:</strong> {{ trottinette.pointRelais.nom }}
                            </p>
                            <p class=\"card-text\">
                                <i class=\"fas fa-hashtag me-2 text-primary\"></i>
                                <strong>Adresse:</strong> {{ trottinette.pointRelais.adresse }}
                            </p>
                        {% else %}
                ...
                <div class=\"card mb-4\">
                    <div class=\"card-body\">
                        <h5 class=\"card-title mb-3\">Actions Rapides</h5>
                        <div class=\"d-grid gap-2\">
                            <a href=\"{{ path('admin_trottinette_edit', {'id': trottinette.id}) }}\" class=\"btn btn-warning\">
                                <i class=\"fas fa-edit me-2\"></i>Modifier la Trottinette
                            </a>
                            {% if trottinette.etat.value != 'EN_MAINTENANCE' %}
                            ...
                            {% endif %}
                            <form method=\"post\" action=\"{{ path('admin_trottinette_delete', {'id': trottinette.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cette trottinette?');\">
...
{% endblock %}", "admin/trottinette/show.html.twig", "C:\\Users\\PC\\Downloads\\inetgration symfony\\my_project_troti-vf\\my_project_troti-vf\\templates\\admin\\trottinette\\show.html.twig");
    }
}
