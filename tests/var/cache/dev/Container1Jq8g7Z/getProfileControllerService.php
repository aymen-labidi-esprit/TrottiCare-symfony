...
class getProfileControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Client'.\DIRECTORY_SEPARATOR.'ProfileController.php';

        $container->services['App\\Controller\\Client\\ProfileController'] = $instance = new \App\Controller\Client\ProfileController();
