...
class ProfileType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('details', TextareaType::class, [ // Use TextareaType
        'label' => 'À propos de moi / Bio',
        'required' => false,
        'attr' => [
            'rows' => 6, // Optional: Set default rows
            'id' => 'client_profile_details_editor' // *** ADD A UNIQUE ID ***
        ]
    ]);
