...
class __TwigTemplate_9fd176a4ea5a20f4d5b612cd50e5459b extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 18
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 18, $this->source); })()), "getTotalItemCount", [], "any", false, false, false, 18), "html", null, true);
        yield " Participants</span>
            </div>
            <div class=\"card-body\">
                ";
        // line 21
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 21, $this->source); })())) > 0)) {
            // line 22
            ...
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 35, $this->source); })()));
            $context['loop'] = [
...
$context["participant"], "statut", [], "any", false, false, false, 45), "value", [], "any", false, false, false, 45) == "ANNULE")) {
            ...
            yield "                            </tbody>
                    ...
                    <div class=\"d-flex justify-content-center mt-4\">
                        ";
            // line 67
            yield $this->env->getRuntime('Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationRuntime')->render($this->env, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 67, $this->source); })()));
            yield "
                    </div>
                ";
        } else {
...
";
    ...
    {
        return array (  252 => 74,  246 => 70,  240 => 67,  232 => 61,  213 => 56,  205 => 51,  202 => 50,  198 => 48,  194 => 46,  192 => 45,  189 => 44,  187 => 43,  181 => 40,  177 => 39,  173 => 38,  169 => 37,  166 => 36,  149 => 35,  134 => 22,  132 => 21,  126 => 18,  122 => 17,  110 => 10,  106 => 9,  101 => 6,  88 => 5,  64 => 3,  41 => 1,);
    }
    ...
    <div class=\"container mt-4\">
        ...
        <div class=\"card\">
            <div class=\"card-header bg-primary text-white d-flex justify-content-between align-items-center\">
                ...
                <span class=\"badge bg-light text-dark fs-5\">{{ pagination.getTotalItemCount }} Participants</span>
            </div>
            <div class=\"card-body\">
