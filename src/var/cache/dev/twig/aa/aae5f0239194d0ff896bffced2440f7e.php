...
class __TwigTemplate_5a4efe0802c5cd564fc870eedc94ac55 extends Template
{
...
$context["event"], "statut", [], "any", false, false, false, 53) == "TERMINE")) {
            ...
            yield "\" class=\"btn btn-warning\" title=\"Edit\">
                                        ...
                                        <a href=\"";
            // line 70
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_event_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["event"], "id", [], "any", false, false, false, 70)]), "html", null, true);
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class=\"btn-group btn-group-sm\">
                                        ...
                                        <a href=\"{{ path('app_event_show', {'id': event.id}) }}\" class=\"btn btn-primary\" title=\"Participants\">
                                            <i class=\"fas fa-users\"></i>
                                        </a>
...
{% endblock %}
", "admin/events.html.twig", "C:\\Users\\Baha Ayadi\\Desktop\\Trotticare Events\\Events\\templates\\admin\\events.html.twig");
    }
}
